...
const WeatherBackground = ({ condition }) => {
    ...
    const getBackground=() =>{
        ...
        return(
            ...
            {background === video ?(
                <video autoPlay loop muted className='w-full h-full object-cover opacity-100 pointer-evnets-none
                animate-fade-in'>
                    <source src={video} type='video/mp4' />

                </video>
            ):(
                <img src={background} alt='weather-bg' className='w-full h-full object-cover opacity-20 pointer-evnets-none
                animate-fade-in'/>
